...
public class PersonDao {
    ...
    public Person getPersonsByName(String personName) throws SQLException {
    	...
    	return template.queryForObject(sql, new Object[] {personName}, new BeanPropertyRowMapper<Person>(Person.class));
    }
    ...
    public Person getPersonsByServiceNumber(String serviceNumber) throws SQLException {
    	...
    	return template.queryForObject(sql, new Object[] {serviceNumber}, new BeanPropertyRowMapper<Person>(Person.class));
    }
    ...
    public Person getPersonsByConsumedUnits(int consumedUnits) throws SQLException {
    	...
    	return template.queryForObject(sql, new Object[] {consumedUnits}, new BeanPropertyRowMapper<Person>(Person.class));
    }
}
