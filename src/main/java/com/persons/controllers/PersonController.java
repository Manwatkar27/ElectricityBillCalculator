...
public class PersonController {
    ...
    public ModelAndView calculateAmountForConsumedUnits(@ModelAttribute("person") Person person) {
    	...
    	try {
    		...
    		if(null != person1) {
    			System.out.println(person1.getId() +  "..." + person1.getName() + "..." + person1.getServiceNumber() + "..consumed units.." + person1.getConsumedUnits());
    			...
    			System.out.println("electricityChargesToPay.."+electricityChargesNeedToPay);
